...
// 外部flash存储空间分配
// 目录区域分配
#define		DM_APP_CATALOG_AREA_START_ADD			0x80000
#define		DM_APP_CATALOG_AREA_LENGTH				0x20000

// 数据区域分配
#define		DM_APP_DATA_AREA_START_ADD				0xA0000
#define		DM_APP_DATA_AREA_LENGTH					0x58000
